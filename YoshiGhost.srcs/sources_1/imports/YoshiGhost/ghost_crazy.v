module ghost_crazy(
    ...
    output wire [9:0] ghost_crazy_x, ghost_crazy_y,
...
assign col = dir_reg == RIGHT ? x - sprite_x_reg : (TIME_MAX - 1 - (x - sprite_x_reg));
assign row = y + face_type - sprite_y_reg;

wire [11:0] color_data;

ghost_crazy_rom ghost_crazy_unit (.clk(clk), .row(row), .col(col), .color_data(rgb_out));
