module ghost_bottom (
    ...
    output wire [9:0] ghost_bottom_x, ghost_bottom_y,
...
assign col = dir_reg == RIGHT ? x - sprite_x_reg : (TITLE_WIDTH - 1 - (x - sprite_x_reg)); 
